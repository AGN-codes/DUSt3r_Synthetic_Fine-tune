...
def get_args_parser():
    ...
    # +++ Freeze arg +++
# +++ ADD THIS LINE INSTEAD OF THE PREVIOUS ONE +++
    parser.add_argument('--trainable', default='', type=str, 
                        help="Comma-separated list of parameter prefixes to keep trainable (e.g., 'head,decoder'). All other layers will be frozen.")
...
# NEW FREEZING BLOCK (Inverted Logic)
    if args.trainable:
        ...
        for name, param in model_without_ddp.named_parameters():
            # If the parameter name starts with any of the trainable prefixes, keep it trainable
